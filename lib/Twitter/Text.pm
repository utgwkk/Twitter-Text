...
sub extract_cashtags {
    Twitter::Text::Extractor->extract_cashtags(@_);
}

sub extract_cashtags_with_indices {
    Twitter::Text::Extractor->extract_cashtags_with_indices(@_);
}

sub extract_hashtags {
    Twitter::Text::Extractor->extract_hashtags(@_);
}
sub extract_hashtags_with_indices {
    Twitter::Text::Extractor->extract_hashtags_with_indices(@_);
}
sub extract_mentioned_screen_names {
    Twitter::Text::Extractor->extract_mentioned_screen_names(@_);
}
sub extract_mentioned_screen_names_with_indices {
    Twitter::Text::Extractor->extract_mentioned_screen_names_with_indices(@_);
}
sub extract_mentions_or_lists_with_indices {
    Twitter::Text::Extractor->extract_mentions_or_lists_with_indices(@_);
}
sub extract_urls {
    Twitter::Text::Extractor->extract_urls(@_);
}
sub extract_urls_with_indices {
    Twitter::Text::Extractor->extract_urls_with_indices(@_);
}
